...
int main(int arg_c, char **args) {
    ...
    system("gcc ../src/world.c -c -Wall -o objects/world.o");
    system("gcc objects/main.o objects/vec2.o objects/gui.o objects/utils.o objects/world.o -o out/silverstriker.exe -L../libs -l:libraylib.a -lopengl32 -lgdi32 -lwinmm");
    return 0;
}